...
<!--        使用的时候需要给组件传参，参数是标题内容-->
        <div class="tabControl_item" v-for="(item,index) in tabControl_title" :class="{tabControl_item_active:index == currentIndex}" @click="itemClick(index)" :key="index">{{item}}</div>
